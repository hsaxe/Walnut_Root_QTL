...
## Load SNP data
```{r}
SNPs = read.csv("SCRI_Root_SNP_Jm_31.09.csv")
...
fwrite(SNPs2, 'R_qtl_SCRI_Root_SNPs_Jm_31.09.csv')
...
fwrite(M, 'SCRI_ROOT_SNPs_cleaned_rQTL_Jm_31.09.csv')
```
...
fwrite(M, 'SCRI_ROOT_SNPs_cleaned_RFE_Jm_31.09.csv')
```
...
```{r}
M = fread('SCRI_ROOT_SNPs_cleaned_Jm_31.09.csv')
